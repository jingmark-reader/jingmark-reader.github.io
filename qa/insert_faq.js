...
const T = {
  en: {
    ...
    a6: "Yes. Aura Reader renders KaTeX math formulas and Mermaid diagrams natively — just write standard LaTeX or Mermaid syntax in your Markdown.",
  ...
  zh: {
    ...
    q6: "是否支持数学公式与图表？",
    a6: "支持。Aura Reader 原生渲染 KaTeX 数学公式与 Mermaid 图表——只需在 Markdown 中书写标准 LaTeX 或 Mermaid 语法即可。",
    q7: "支持多少种语言？",
  ...
  "zh-tw": {
    ...
    q6: "是否支援數學公式與圖表？",
    a6: "支援。Aura Reader 原生渲染 KaTeX 數學公式與 Mermaid 圖表——只需在 Markdown 中書寫標準 LaTeX 或 Mermaid 語法即可。",
    q7: "支援多少種語言？",
  ...
  ja: {
    ...
    q6: "数式や図表に対応していますか？",
    a6: "はい。Aura Reader は KaTeX の数式と Mermaid の図表をネイティブに描画します——Markdown に標準的な LaTeX または Mermaid の構文を書くだけで大丈夫です。",
    q7: "対応言語はいくつありますか？",
  ...
  ko: {
    ...
    q6: "수식과 다이어그램을 지원하나요?",
    a6: "예. Aura Reader는 KaTeX 수식과 Mermaid 다이어그램을 네이티브로 렌더링합니다——Markdown에 표준 LaTeX 또는 Mermaid 구문을 작성하기만 하면 됩니다.",
    q7: "몇 개의 언어를 지원하나요?",
  ...
  fr: {
    ...
    a6: "Oui. Aura Reader rend nativement les formules KaTeX et les diagrammes Mermaid — il suffit d'écrire la syntaxe LaTeX ou Mermaid standard dans votre Markdown.",
  ...
  de: {
    ...
    a6: "Ja. Aura Reader rendert KaTeX-Formeln und Mermaid-Diagramme nativ — schreiben Sie einfach Standard-LaTeX- oder Mermaid-Syntax in Ihr Markdown.",
  ...
  es: {
    ...
    a6: "Sí. Aura Reader renderiza fórmulas KaTeX y diagramas Mermaid de forma nativa — solo tienes que escribir la sintaxis LaTeX o Mermaid estándar en tu Markdown.",
  ...
  pt: {
    ...
    a6: "Sim. O Aura Reader renderiza fórmulas KaTeX e diagramas Mermaid nativamente — basta escrever a sintaxe LaTeX ou Mermaid padrão no seu Markdown.",
  ...
  ru: {
    ...
    a6: "Да. Aura Reader отображает формулы KaTeX и диаграммы Mermaid встроенными средствами — достаточно написать стандартный синтаксис LaTeX или Mermaid в вашем Markdown.",
  ...
  vi: {
    ...
    a6: "Có. Aura Reader hiển thị trực tiếp công thức KaTeX và sơ đồ Mermaid — bạn chỉ cần viết cú pháp LaTeX hoặc Mermaid chuẩn trong Markdown.",
  ...
  sv: {
    ...
    a6: "Ja. Aura Reader återger KaTeX-formler och Mermaid-diagram nativt — du skriver bara standard LaTeX- eller Mermaid-syntax i din Markdown.",
  ...
  ar: {
    ...
    a6: "نعم. يعرض Aura Reader معادلات KaTeX ومخططات Mermaid أصليًا — ما عليك سوى كتابة صيغة LaTeX أو Mermaid القياسية في Markdown الخاص بك.",
